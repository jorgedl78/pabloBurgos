...
QuickWindow          WINDOW('Selección de Destinatario'),AT(,,220,193),FONT('MS Sans Serif',8,,),COLOR(0E2F1F1H),IMM,SYSTEM,GRAY,DOUBLE,MDI
                       LIST,AT(12,26,194,139),USE(?Browse:1),IMM,VSCROLL,COLOR(0FFFF80H,COLOR:Black,080FF80H),FORMAT('36R(3)|F~Código~L(2)@n6.@160L(2)|F~Nombre~@s40@'),FROM(Queue:Browse:1)
