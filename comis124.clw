...
totales                DETAIL,AT(,,,240),USE(?totales),FONT('Arial',8,,FONT:regular,CHARSET:ANSI)
                         ...
                         STRING(@n-13.2),AT(5229,52),SUM,USE(loc:NoGravado,,?loc:NoGravado:2),TRN,RIGHT(1),FONT(,,,FONT:bold),TALLY(detalle)
                         STRING(@n-13.2),AT(5948,52),SUM,USE(FCP:NetoGravado,,?FCP:NetoGravado:2),TRN,RIGHT(1),FONT(,,,FONT:bold),TALLY(detalle)
                         STRING(@n-13.2),AT(6594,52),SUM,USE(FCP:Iva21,,?FCP:Iva21:2),TRN,RIGHT(2),FONT(,,,FONT:bold),TALLY(detalle)
                         STRING(@n-13.2),AT(7323,52),SUM,USE(FCP:Iva10,,?FCP:Iva10:2),TRN,RIGHT(2),FONT(,,,FONT:bold),TALLY(detalle)
                         STRING(@n-13.2),AT(8021,52),SUM,USE(FCP:Iva27,,?FCP:Iva27:2),TRN,RIGHT(2),FONT(,,,FONT:bold),TALLY(detalle)
                         STRING(@n-13.2),AT(8729,52),SUM,USE(FCP:ImpuestosInternos,,?FCP:ImpuestosInternos:2),TRN,RIGHT(2),FONT(,,,FONT:bold),TALLY(detalle)
                         STRING(@n-13.2),AT(9438,52),SUM,USE(FCP:PercepIVA,,?FCP:PercepIVA:2),TRN,RIGHT(2),FONT(,,,FONT:bold),TALLY(detalle)
                         STRING(@n-13.2),AT(10052,52),SUM,USE(FCP:Importe,,?FCP:Importe:2),TRN,RIGHT(2),FONT(,,,FONT:bold),TALLY(detalle)
                       END
                     END
