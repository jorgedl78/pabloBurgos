   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('COMIS097.INC'),ONCE        !Local module procedure declarations
                     END


ImpresionRecibo3 PROCEDURE                                 ! Generated from procedure template - Report
...
cabecera               DETAIL,AT(,,,2396),USE(?cabecera)
                         ...
                         STRING('Trans'),AT(583,0),USE(?String1),TRN,FONT('Brush Script MT',30,,FONT:italic)
                         STRING(@s1),AT(3552,135),USE(FAC:Letra),TRN,CENTER,FONT(,18,,FONT:bold)
                         STRING('PABLO'),AT(1469,-52,1615,573),USE(?String55),TRN,FONT('Arial Black',28,,FONT:bold+FONT:italic,CHARSET:ANSI)
                         ...
                         STRING('de Romina E. Sanchez'),AT(1073,406),USE(?String2),TRN,FONT(,10,,FONT:bold)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ImpresionRecibo3')
