...
guias                  DETAIL,USE(?guias)
                       ...
                       END
                       FORM,AT(229,9292,8000,1344),USE(?Form),FONT('MS Sans Serif',8,,FONT:regular)
                         STRING('TOTAL'),AT(6229,125),USE(?String25),TRN,FONT(,,,FONT:bold,CHARSET:ANSI)
                         STRING('%'),AT(3896,125),USE(?String23:4),TRN,FONT(,,,FONT:bold,CHARSET:ANSI)
                         STRING(@n_5.2),AT(3521,125),USE(loc:porcentajeiva),TRN,FONT(,,,FONT:bold,CHARSET:ANSI)
                         LINE,AT(94,42,7813,0),USE(?Line4:2),COLOR(COLOR:Black)
                         STRING('NETO'),AT(417,125),USE(?String23),TRN,FONT(,,,FONT:bold,CHARSET:ANSI)
                         STRING('IVA'),AT(3302,125),USE(?String24),TRN,FONT(,,,FONT:bold,CHARSET:ANSI)
                         BOX,AT(63,323,7854,427),USE(?HeaderBox:2),COLOR(COLOR:Black)
                         STRING(@n-11.2),AT(333,510),USE(loc:Subtotal),RIGHT(2)
                         STRING(@n-11.2),AT(5938,521),USE(FAC:Importe),RIGHT(1)
                         STRING('Alias: pabloysantiagoburgos'),AT(5073,927),USE(?String23:5),TRN,FONT(,,,FONT:bold,CHARSET:ANSI)
                         STRING(@n-10.2),AT(3167,500),USE(loc:iva),RIGHT(2)
                         STRING(@d6),AT(3188,927),USE(FAC:FechaCAE)
                         STRING('Vencimiento:'),AT(2375,927),USE(?String23:3),TRN,FONT(,,,FONT:bold,CHARSET:ANSI)
                         STRING(@s20),AT(771,927),USE(FAC:CAE)
                         STRING('CAE:'),AT(448,927),USE(?String23:2),TRN,FONT(,,,FONT:bold,CHARSET:ANSI)
                       END
                     END
