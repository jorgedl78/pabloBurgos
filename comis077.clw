   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('COMIS077.INC'),ONCE        !Local module procedure declarations
                     END


ImpresionFactura1 PROCEDURE                                ! Generated from procedure template - Report
...
encabezado             DETAIL,AT(,,,3625),USE(?encabezado)
                         ...
                         STRING('X'),AT(1958,1656,292,198),USE(?IVA3),TRN,HIDE,CENTER,FONT('Arial',12,,FONT:regular)
                         STRING('X'),AT(1927,1646,292,198),USE(?IVA2),TRN,HIDE,CENTER,FONT('Arial',12,,FONT:regular)
                         STRING('X'),AT(1042,1656,292,198),USE(?IVA4),TRN,HIDE,CENTER,FONT('Arial',12,,FONT:regular)
                         STRING('X'),AT(1271,1656,292,198),USE(?IVA1),TRN,HIDE,CENTER,FONT('Arial',12,,FONT:regular)
                         STRING('X'),AT(2969,1656,292,198),USE(?IVA6),TRN,HIDE,CENTER,FONT('Arial',12,,FONT:regular)
                         STRING('X'),AT(3604,1990,292,198),USE(?Transporte),TRN,HIDE,CENTER,FONT('Arial',12,COLOR:Black,FONT:regular)
                         STRING('X'),AT(4521,1990,292,198),USE(?Comision),TRN,HIDE,CENTER,FONT('Arial',12,COLOR:Black,FONT:regular)
                         STRING('X'),AT(6594,1656,292,198),USE(?IVA5),TRN,HIDE,CENTER,FONT('Arial',12,,FONT:regular)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ImpresionFactura1')
