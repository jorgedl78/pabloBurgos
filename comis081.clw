   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('COMIS081.INC'),ONCE        !Local module procedure declarations
                     END


ImpresionGuia3 PROCEDURE                                   ! Generated from procedure template - Report
...
encabezado             DETAIL,AT(,,,3135),USE(?encabezado)
                         ...
                         STRING('PABLO'),AT(1448,-42,1656,573),USE(?String1:2),TRN,FONT('Arial Black',28,,FONT:bold+FONT:italic)
                         ...
                         STRING('Trans'),AT(542,0),USE(?String1),TRN,FONT('Brush Script MT',30,,FONT:italic)
                         ...
                         STRING('de Romina E. Sanchez'),AT(1031,417),USE(?String2),TRN,FONT(,10,COLOR:Black,FONT:bold)
                         ...
                         STRING('Mariano Moreno 861'),AT(260,688),USE(?String3),TRN
                         ...
                         STRING('pabloandresburgos@yahoo.com.ar'),AT(1552,844),USE(?String38:2),TRN
...
pie                    DETAIL,AT(,,,1490),USE(?pie)
                         ...
                         STRING('CONDICIONES ESPECIALES DEL TRANSPORTE'),AT(3750,21),USE(?String45),TRN,FONT(,7,COLOR:Black,)
                         STRING('TOTAL'),AT(2594,73),USE(?String33),TRN,FONT(,,COLOR:Black,FONT:bold)
                         STRING(@n12.2),AT(2917,73),USE(GUIA:Importe),TRN,RIGHT(2)
                         STRING('1)  El comisionista NO se hará RESPONSABLE del DINERO EN EFECTIVO'),AT(3823,188),USE(?String45:2),TRN,FONT(,7,COLOR:Black,)
                         LINE,AT(2563,260,1140,0),USE(?Line9),COLOR(COLOR:Black)
                         STRING('proveniente de contrarreembolso o pagos a efectuar.'),AT(3823,302),USE(?String45:3),TRN,FONT(,7,COLOR:Black,)
                         STRING('2)  El comisionista NO se hará RESPONSABLE de documentos y efectos'),AT(3823,458),USE(?String45:4),TRN,FONT(,7,COLOR:Black,)
                         STRING('. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .'),AT(146,156),USE(?String36),TRN
                         STRING('y contenido. En caso de pérdida o avería no estará obligado a indemnizar'),AT(3823,708),USE(?String45:6),TRN,FONT(,7,COLOR:Black,)
                         STRING('. . . . . . . . . . . . . . . . . .'),AT(135,729),USE(?String36:2),TRN
                         STRING('de valor, si al tiempo de entrega, el remitente no hubiera declarado su valor'),AT(3823,583),USE(?String45:5),TRN,FONT(,7,COLOR:Black,)
                         ...
                         STRING('más que el valor declarado.'),AT(3823,833),USE(?String45:7),TRN,FONT(,7,COLOR:Black,)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ImpresionGuia3')
