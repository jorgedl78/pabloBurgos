   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('COMIS051.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('COMIS018.INC'),ONCE        !Req'd for module callout resolution
                     END


UpdateDESTINATARIO PROCEDURE                               ! Generated from procedure template - Window
...
Window               WINDOW('Agregando CLIENTE'),AT(,,244,139),FONT('MS Sans Serif',8,COLOR:Black,FONT:regular),GRAY,DOUBLE
                       SHEET,AT(11,8,221,105),USE(?Sheet1)
                         ...
                         END
                       END
                       BUTTON('Grabar'),AT(63,119,55,16),USE(?OK),DISABLE,LEFT,FONT(,,COLOR:Black,FONT:bold),ICON('C:\1L\Comisiones\botones\Ok1.ico')
                       BUTTON('Cancelar'),AT(127,119,55,16),USE(?CancelButton),LEFT,ICON('C:\1L\Comisiones\botones\Cancel1.ico'),STD(STD:Close)
                     END
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('UpdateDESTINATARIO')
