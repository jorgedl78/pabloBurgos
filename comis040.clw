   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('COMIS040.INC'),ONCE        !Local module procedure declarations
                     END


HojaRutaEmpresa PROCEDURE                                  ! Generated from procedure template - Report
...
report               REPORT,AT(656,948,7135,10146),PAPER(PAPER:A4),PRE(RPT),FONT('Arial',8,,FONT:regular),THOUS
                       HEADER,AT(656,323,7146,594),FONT('Arial',9,COLOR:Black,FONT:regular)
                         ...
                         STRING(@s35),AT(771,177,2625,188),USE(PAR:RazonSocial),TRN,FONT(,,,FONT:bold)
                         STRING(@N3),AT(6677,177),USE(ReportPageNumber),TRN
                         STRING('EMPRESA:'),AT(73,177),USE(?String26),TRN
                         ...
                         STRING('HOJA DE RUTA DEL DIA'),AT(73,10),USE(?String1),TRN
                       END
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('HojaRutaEmpresa')
  ...
  ThisReport.SetFilter('GUIA:Empresa = glo:Empresa AND GUIA:Impresa <<> ''A''')
