   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('COMIS115.INC'),ONCE        !Local module procedure declarations
                     END


ContraReembolsosTransporte PROCEDURE                       ! Generated from procedure template - Report
...
report               REPORT,AT(656,948,7135,10146),PAPER(PAPER:A4),PRE(RPT),FONT('Arial',8,COLOR:Black,FONT:regular),THOUS
                       HEADER,AT(656,323,7146,594),FONT('Arial',9,,FONT:regular)
                         ...
                         STRING('Fecha'),AT(323,365),USE(?String5:3),TRN,FONT(,,,FONT:bold)
                         STRING('Remito-Guía'),AT(813,365),USE(?String5:4),TRN,FONT(,,,FONT:bold)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ContraReembolsosTransporte')
  ...
  ThisReport.Init(Process:View, Relate:GUIAS, ?Progress:PctText, Progress:Thermometer, ProgressMgr, GUIA:Redespacho)
  ThisReport.AddSortOrder(GUIA:Por_Redespacho)
  ThisReport.AddRange(GUIA:Redespacho,glo:Transporte)
