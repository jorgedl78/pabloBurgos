...
QuickWindow          WINDOW('Selección de Distribuidor'),AT(,,192,142),FONT('MS Sans Serif',8,,),COLOR(0E2F1F1H),CENTER,IMM,SYSTEM,GRAY,DOUBLE
                       LIST,AT(13,23,168,91),USE(?Browse:1),IMM,VSCROLL,COLOR(0FFFF80H,COLOR:Black,080FF80H),FORMAT('28R(3)|F~Código~C(0)@n3@127L(2)|F~Nombre~@s35@'),FROM(Queue:Browse:1)
